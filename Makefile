...
CFLAGS = -Wall -Ipicocoin/include -D STANDALONE -D NN_USE_POLL= -D NN_HAVE_POLL= -D NN_HAVE_PIPE=  -D NN_USE_LITERAL_IFADDR= -D NN_HAVE_MSG_CONTROL=  -D __PNACL
...
TRANSPORT_TESTS = \
    nanosrc/tests/inproc \
    nanosrc/tests/inproc_shutdown \
    nanosrc/tests/ipc \
    nanosrc/tests/ipc_shutdown \
    nanosrc/tests/ipc_stress \
    nanosrc/tests/tcp \
    nanosrc/tests/tcp_shutdown \
    nanosrc/tests/ws \
    nanosrc/tests/tcpmux

PROTOCOL_TESTS = \
    nanosrc/tests/pair \
    nanosrc/tests/pubsub \
    nanosrc/tests/reqrep \
    nanosrc/tests/pipeline \
    nanosrc/tests/survey \
    nanosrc/tests/bus
...
FEATURE_TESTS = \
    ...
    nanosrc/tests/prio \
    nanosrc/tests/poll \
    nanosrc/tests/device \
    nanosrc/tests/emfile \
    nanosrc/tests/domain \
    nanosrc/tests/trie \
    nanosrc/tests/list \
    nanosrc/tests/hash \
    nanosrc/tests/symbol \
    nanosrc/tests/separation \
    nanosrc/tests/zerocopy \
    nanosrc/tests/shutdown \
    nanosrc/tests/cmsg
