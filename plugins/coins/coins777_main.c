...
struct coin777 *coin777_create(char *coinstr,cJSON *argjson)
{
    ...
    COINS.LIST = (struct coin777 **)realloc(COINS.LIST,(COINS.num+1) * sizeof(struct coin777 *));
...
uint64_t PLUGNAME(_register)(struct plugin_info *plugin,STRUCTNAME *data,cJSON *argjson)
{
    ...
    printf("register init %s size.%d\n",plugin->name,(int32_t)sizeof(struct coins_info));
    COINS.readyflag = 1;
